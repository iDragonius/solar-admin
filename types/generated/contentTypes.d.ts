...
export interface ApiCertificateCertificate extends Schema.SingleType {
  ...
  attributes: {
    certificates: Attribute.Component<'common.certificate', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    animatedTexts: Attribute.Component<'common.animated', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    about: Attribute.Component<'common.about', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNavigationNavigation extends Schema.SingleType {
  ...
  attributes: {
    navigations: Attribute.Component<'navigation.navigation', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
